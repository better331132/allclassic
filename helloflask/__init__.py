...
#     prac_address = request.form.get('prac_address')
#     perf_address = request.form.get('perf_address')
#     detail_textarea = request.form.get('detail_textarea')
#     song_textarea = request.form.get('song_textarea')
